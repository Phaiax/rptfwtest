...
void ui_check_keys(int &action) {
 ...
 UI_KEYS_BUTTON_LOW(31,UI_ACTION_OK); // push button, connects gnd to pin
 UI_KEYS_BUTTON_LOW(33,UI_ACTION_NEXT); // push button, connects gnd to pin
 UI_KEYS_BUTTON_LOW(35,UI_ACTION_PREVIOUS); // push button, connects gnd to pin
